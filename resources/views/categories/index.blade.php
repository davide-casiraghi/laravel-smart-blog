    ...
    <div class="container max-w-md px-0">
        <div class="row">
            <div class="col-12 col-sm-7">
                <h4>@lang('laravel-smart-blog::category.category_management')</h4>
            </div>    
            <div class="col-12 col-sm-5 mt-sm-0 text-right">
                <a class="btn btn-success create-new" href="{{ route('categories.create') }}"><i class="fa fas fa-plus-circle"></i> @lang('laravel-smart-blog::category.create_category')</a>
            </div>
        </div>
                    ...
                    {{-- Buttons --}}
                        <div class="col-12 pb-2 action">
                            <form action="{{ route('categories.destroy',$category->id) }}" method="POST">
                                ...
                                <a class="btn btn-primary float-right" href="{{ route('categories.edit',$category->id) }}">@lang('laravel-smart-blog::general.edit')</a>
